...
#define DEFAULT_NGINX_CONF_PATH "/usr/local/nginx/conf/nginx.conf"
...
int main( int argc , char ** argv)
{
    ...
    database_hash_init();
    //LOG_WARN("bbbbbbbbbbbbbbbbbbbbbbbbb\n");

    netctl_hash_init();
    //LOG_WARN("cccccccccccccccccccccccccccccccc\n");

    pthread_create(&thread_id, NULL, (void*)main_init, NULL);
    //LOG_WARN("dddddddddddddddddddddddddddddddd\n");

    g_main_loop_run(main_loop);
    //LOG_WARN("eeeeeeeeeeeeeeeeeeeeeeeeeeee\n");
