...
char *rkdb_sql(char *sql)
{
    ...
    if (rc != SQLITE_OK) {
        ...
        json_object_object_add(j_cfg, "sErrMsg", json_object_new_string(""));
           printf("sqlite3_exec Operation done successfully!!!!!!!\n");
    }
