...
void VideoApiHandler::handler(const HttpRequest &Req, HttpResponse &Resp) {
  minilog_debug("video_video_video_video_video_video_video_video_video_video_");
  ...
  if (Req.Method == "GET") {
   ...
   // nlohmann::json video_current_config = "{\"iGOP\":50,\"iMaxRate\":1024,\"iMinRate\":0,\"iStreamSmooth\":50,\"iTargetRate\":0,\"id\":1,\"sFrameRate\":\"25\",\"sFrameRateIn\":\"25\",\"sH264Profile\":\"high\",\"sOutputDataType\":\"H.264\",\"sRCMode\":\"CBR\",\"sRCQuality\":\"high\",\"sResolution\":\"640*480\",\"sSVC\":\"close\",\"sSmart\":\"close\",\"sStreamType\":\"subStream\",\"sVideoEncoderConfigurationName\":\"VideoEncoder_1\",\"sVideoEncoderConfigurationToken\":\"VideoEncoderToken_1\",\"sVideoSourceToken\":\"VideoSource_0\",\"sVideoType\":\"compositeStream\"}"_json;
